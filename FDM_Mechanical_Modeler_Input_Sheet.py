...
NAME:
MECHANICAL FDM MODELER - INPUT SHEET
...
"""Mechanical"""
"""Spring Constant Output"""
Spring="Y" #("Y" or "N")
"""Displacement"""
Displacement="Y" #("Y" or "N")

"""Thermal (Bimetallic) Displacement"""
Th_Displacement="N" #("Y" or "N")

"""Sensitivity Analysis"""
SensitivityAnalysis="N" #("Y" or "N")
...
#Analysed Input
SI="_"                 #Equals the Algebraic Term with Quotes
#Start Value
SS=0 
#End Value
SE=0
